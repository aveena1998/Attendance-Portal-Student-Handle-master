...
public class MyProfileActivity extends AppCompatActivity {
    ...
    private TextView mName,mName1,mrollno, mPhone,memail,myear,mbranch,meditprofile,mStudent;
    ...
    private String userid,name,phone,email,branch,year,rollno,profileimageurl;
    SaveTheme saveTheme;
    @Override
...
//        progressBar.setVisibility(View.INVISIBLE);
        mStudent.setVisibility(View.INVISIBLE);
